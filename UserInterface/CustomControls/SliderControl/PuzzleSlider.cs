...
namespace UserInterface.CustomControls
{
  ...
  public class PuzzleSlider : Canvas
  {
    ...
    private void AddAnimationsToStoryBoard(Tile valueTile, int index = 0, int duration = PlayerAnimationDuration)
    {
      ...
      var tileAnimation = CreateSlidingAnimation(valueTile, blankTile.DestinationMargin, beginTime, duration);
      var blankAnimation = CreateSlidingAnimation(blankTile, valueTile.DestinationMargin, beginTime, duration);
    ...
    private Tile BuildTile(int tileIndex)
    {
      ...
      var sliderTile = new Tile
      {
        ...
        Margin = GetMarginForTileIndex(tileIndex),
        DestinationMargin = GetMarginForTileIndex(tileIndex),
      };
    ...
    private void InitSlider()
    {
      ...
      for (int tileIndex = 0; tileIndex < _rowsCount * _rowsCount; tileIndex++)
      {
        ...
        _tileToPositionMap.Add(sliderTile, tileIndex);
      }
