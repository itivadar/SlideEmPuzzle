...
namespace UserInterface.Pages.PuzzleSelectorPage
{
  public class PuzzleSelectorViewModel : ViewModelBase
  {
    ...
    private void OnStartGame(string puzzleTypeSelected)
    {
      ...
      EventAggregator.GetEvent<PuzzleTypeSelectedEvent>().Publish(PuzzleSelected);
      NavigationService.ShowPageAfterDelay(AppPages.SliderPage, TimeSpan.FromMilliseconds(1200));
    }
